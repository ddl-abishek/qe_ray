...
Pre condition
Make sure atleast 3 workers - no GPUS on worker nodes
Note: Code has been modified for 100 iterations

To use this example run
python torch_simple_example_no_gpu.py --num_workers 3 --use_gpu False
